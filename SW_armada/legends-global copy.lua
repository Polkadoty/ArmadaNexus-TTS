...
function spawnShields(ship)
    ...
    --    ship.setPosition({pos[1],15,pos[3]})
        ...
        elseif size==6 then --custom wideHuge size, array 6 in ships[] 
            table.insert(offsets,{-math.abs(o[1]),0,6.15}) --wideHuge front left shield offset
            table.insert(offsets,{math.abs(o[1]),0,6.15}) --wideHuge front right shield offset
        elseif size==7 then --custom megaWideHuge size, array 7 in ships[] 
            table.insert(offsets,{-math.abs(o[1]),0,6.15}) --megaWideHuge front left shield offset
            table.insert(offsets,{math.abs(o[1]),0,6.15}) --megaWideHuge front right shield offset
