...
function onload()
    ...
    Card:new(SuperWeapon, Separatist,
    ...
    Card:new(Ordnance,
        {
            name = "Long Range Concussion Missiles",
            front = LEGACY_ASSETS ..
                "cards/ord/long-range-concussion-missiles.jpg",
            cost = 4,
            aliases = { "Long Range Concussion Missiles [OldLegacy]" }
        })
    Card:new(Ordnance,
    ...
    Card:new(WeaponsTeamAndOffensiveRetrofit, Separatist,
